...
// print an error message on stderr when system call fails and exit with a return code of 2
...
void print_usage() {
    fprintf(stderr, "Usage: lab4c_tls --id=9-digit-number --host=name-or-address --log=filename port_number [--period=#] [--scale=C/F]\n");
}
